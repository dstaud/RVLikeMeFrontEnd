...
export class PersonalComponent implements OnInit {
  ...
  Genders: Gender[] = [
    {value: '', viewValue: ''},
    {value: 'M', viewValue: 'profile.component.list.gender.male'},
    {value: 'F', viewValue: 'profile.component.list.gender.female'}
  ];

  Countries: Country[] = [
    {value: '', viewValue: ''},
    {value: 'USA', viewValue: 'profile.component.list.country.usa'},
    {value: 'CAN', viewValue: 'profile.component.list.country.can'}
  ];

  States: State[] = [
    {value: '', viewValue: ''},
    {value: 'AL', viewValue: 'profile.component.list.state.al'},
    {value: 'AK', viewValue: 'profile.component.list.state.ak'},
    {value: 'AZ', viewValue: 'profile.component.list.state.az'},
    {value: 'AR', viewValue: 'profile.component.list.state.ar'},
    {value: 'CA', viewValue: 'profile.component.list.state.ca'},
    {value: 'CO', viewValue: 'profile.component.list.state.co'},
    {value: 'CT', viewValue: 'profile.component.list.state.ct'},
    {value: 'DE', viewValue: 'profile.component.list.state.de'},
    {value: 'DC', viewValue: 'profile.component.list.state.dc'},
    {value: 'FL', viewValue: 'profile.component.list.state.fl'},
    {value: 'GA', viewValue: 'profile.component.list.state.ga'},
    {value: 'HI', viewValue: 'profile.component.list.state.hi'},
    {value: 'ID', viewValue: 'profile.component.list.state.id'},
    {value: 'IL', viewValue: 'profile.component.list.state.il'},
    {value: 'IN', viewValue: 'profile.component.list.state.in'},
    {value: 'IA', viewValue: 'profile.component.list.state.ia'},
    {value: 'KS', viewValue: 'profile.component.list.state.ks'},
    {value: 'KY', viewValue: 'profile.component.list.state.ky'},
    {value: 'LA', viewValue: 'profile.component.list.state.la'},
    {value: 'ME', viewValue: 'profile.component.list.state.me'},
    {value: 'MD', viewValue: 'profile.component.list.state.md'},
    {value: 'MA', viewValue: 'profile.component.list.state.ma'},
    {value: 'MI', viewValue: 'profile.component.list.state.mi'},
    {value: 'MN', viewValue: 'profile.component.list.state.mn'},
    {value: 'MS', viewValue: 'profile.component.list.state.ms'},
    {value: 'MO', viewValue: 'profile.component.list.state.mo'},
    {value: 'MT', viewValue: 'profile.component.list.state.mt'},
    {value: 'NE', viewValue: 'profile.component.list.state.ne'},
    {value: 'NV', viewValue: 'profile.component.list.state.nv'},
    {value: 'NH', viewValue: 'profile.component.list.state.nh'},
    {value: 'NJ', viewValue: 'profile.component.list.state.nj'},
    {value: 'NM', viewValue: 'profile.component.list.state.nm'},
    {value: 'NY', viewValue: 'profile.component.list.state.ny'},
    {value: 'NC', viewValue: 'profile.component.list.state.nc'},
    {value: 'ND', viewValue: 'profile.component.list.state.nd'},
    {value: 'OH', viewValue: 'profile.component.list.state.oh'},
    {value: 'OK', viewValue: 'profile.component.list.state.ok'},
    {value: 'OR', viewValue: 'profile.component.list.state.or'},
    {value: 'PA', viewValue: 'profile.component.list.state.pa'},
    {value: 'SC', viewValue: 'profile.component.list.state.sc'},
    {value: 'SD', viewValue: 'profile.component.list.state.sd'},
    {value: 'TN', viewValue: 'profile.component.list.state.tn'},
    {value: 'TX', viewValue: 'profile.component.list.state.tx'},
    {value: 'UT', viewValue: 'profile.component.list.state.ut'},
    {value: 'VT', viewValue: 'profile.component.list.state.vt'},
    {value: 'VA', viewValue: 'profile.component.list.state.va'},
    {value: 'WA', viewValue: 'profile.component.list.state.wa'},
    {value: 'WV', viewValue: 'profile.component.list.state.wv'},
    {value: 'WI', viewValue: 'profile.component.list.state.wi'},
    {value: 'WY', viewValue: 'profile.component.list.state.wy'}
    ];
